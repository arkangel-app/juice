...
import phoneTxt from './images/comoparticipar.png';
        ...
        <Row className="filaProductos">
          ...
          <div className="nubesRight">
            ...
            <img className="step" src={paso1}/>
              ...
              <span className="number arg como"><img className="bMedia2 como" src={whats}/>11-6034-6668</span>
              </div>
              <div className="triangle tleft"></div>
            </div>
...
export default withRouter(ComoParticipar);
